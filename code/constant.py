...
import os
FILEPATH = os.getcwd()[:os.getcwd().rfind('graProject')+10]
...
IP_INLAND_URL_PREFIX = 'http://www.kuaidaili.com/free/inha/'
IP_FOREIGH_URL_PREFIX = 'http://www.kuaidaili.com/free/outha/'
